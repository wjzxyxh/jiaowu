...
def set_student_trial_status(student_id):
    ...
    try:
        ...
        if trial_status == '成功' and not had_success_before:
            from backend.models import ClassHoursStats, Payment
            # 删除课时统计
...
def _remove_student_from_management_core(student):
    ...
    from backend.models import ClassHoursStats, Payment, StudentCourseDefaultSchedule, TeacherExperienceCost, TeacherExperienceCostHistory
...
def delete_student(student_id):
    ...
    from backend.models import StudentCourse, ClassHoursStats, Payment, TeacherExperienceCost, StudentCourseDefaultSchedule, TeacherExperienceCostHistory
    ...
    from backend.services.finance_service import update_finance_record
    from backend.utils import get_current_month
...
def get_paid_courses_need_scheduling():
    ...
    try:
        from backend.utils.date_utils import month_calendar_week_end_date
        from backend.services.finance_service import calculate_remaining_hours_from_payments
